...
public class TagihanView extends JFrame {

    public TagihanView() {
        setTitle("Tagihan Uang Kuliah");
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setLayout(null);
        setResizable(true);
        getContentPane().setBackground(new Color(245, 246, 247));

        initComponents("Tagihan Uang Kuliah");
    ...
    private void initComponents(String viewTitle) {
        ...
        title.setForeground(new Color(170, 0, 0)); // Merah (karena ini Tagihan)
        title.setBounds(40, 20, 500, 30);
        mainPanel.add(title);
        
        JLabel info = new JLabel("Informasi status pembayaran uang kuliah Anda.");
