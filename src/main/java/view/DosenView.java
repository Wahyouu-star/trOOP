...
public class DosenView extends JFrame {
    ...
    private final String USER_INFO = "672024097 - PRATAYAKSA OCSA N SAIAN";
    private final String SEMESTER_INFO = "SEMESTER 1 TA 2025 - 2026";
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel infoLabel1 = new JLabel(USER_INFO);
        infoLabel1.setFont(new Font("Segoe UI", Font.BOLD, 14));
        infoLabel1.setForeground(Color.WHITE);
        infoLabel1.setBounds(20, 10, 800, 20);
        panel.add(infoLabel1);
        
        JLabel infoLabel2 = new JLabel(SEMESTER_INFO);
        infoLabel2.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        infoLabel2.setForeground(Color.WHITE);
        infoLabel2.setBounds(20, 35, 800, 15);
    ...
    private JPanel createSidebar() {
        ...
        String[] menuItems = {"HOME", "JADWAL MENGAJAR", "ABSENSI MAHASISWA", 
    ...
    private void addInitialContent() {
        ...
        dynamicContentPanel.add(createPlaceholderPanel("JADWAL MENGAJAR"), "JADWAL MENGAJAR");
        dynamicContentPanel.add(createPlaceholderPanel("ABSENSI MAHASISWA"), "ABSENSI MAHASISWA");
    ...
    private JPanel createHomeWelcomePanel() {
        ...
        JLabel nameLabel = new JLabel("PRATAYAKSA OCSA N SAIAN", SwingConstants.CENTER);
